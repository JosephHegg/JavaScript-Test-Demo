Hello, this project is made to show my knowledge, experiences, and tricks I've learned throughout my professional career as a Software Quality Engineer.
The project was created with HTML, CSS, and JavaScript and is a program I show during interviews to show my ability to use these languages (mainly JavaScript).

The link to this project is on my GitHub which you can access from the main page, however the content is accessed by request-only.
Requests can be sent to: heggjv@rose-hulman.edu
...
One With Little Coverage
Good Coverage No Ascii
Great Coverage w/ Ascii
...
The project is structured by the three principal layers: Presentation / Domain / DataSource
...
1. Install Node.js
2. Install http-server from Node.js
3. Go to the project root directory and run http-server in the command line
4. Navigate to Presentation/main_page.html and access it
5. Navigate the HTML Pages from there
