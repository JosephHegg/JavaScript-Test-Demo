...
function buildPitMutationTextBank(){
	...
	pitMutationTestTextBank.set("submit_button_text", "Run PIT Mutation Test");
	pitMutationTestTextBank.set("submit_response_text", "PIT Mutation Test ran.");
	pitMutationTestTextBank.set("end_observation_standby", "Awaiting PIT Mutation Test Run...");
